...
// yaptıgı seçime göre yönlendiriyoruz.
            ...
            } else if (select.equals("M") || select.equals("G")) {
                System.out.print("kullanıcı giriş sayfanda ayrılıyorsunuz ... iyi günler .");
                // kullanıcı M ve G dışında hatalı tercih yaparsa
            }else {
                System.out.print("Hatalı giriş yaptınız!! Lütfen sadece 'M ve G' seçeneklerinden birini giriniz.");
            }
        }
